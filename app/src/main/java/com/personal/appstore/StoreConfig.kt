...
object StoreConfig {
    ...
    /**
     * Периодичность фоновой проверки обновлений. Раз в шесть часов было мало:
     * релиз выходил сразу после проверки и висел незамеченным полдня.
     * Запрос — несколько килобайт JSON, раз в час это ничего не стоит.
     */
    const val UPDATE_CHECK_INTERVAL_HOURS: Long = 1L
